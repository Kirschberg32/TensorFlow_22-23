...
The following run contains all optimizations except for batch normalization as it seems to make the overfitting worse. As Skip connections it uses a DenseNet architecture.
